      ...
      config = {
        ...
        keybindings = {
          ...
          "XF86AudioRaiseVolume" =
            "exec --no-startup-id ${lib.getExe pkgs.pamixer} --set-limit 150 --allow-boost -i 5";
          "XF86AudioLowerVolume" =
            "exec --no-startup-id ${lib.getExe pkgs.pamixer} --set-limit 150 --allow-boost -d 5";
          "XF86AudioMute" = "exec --no-startup-id ${lib.getExe pkgs.pamixer} --toggle-mute";
          "XF86AudioMicMute" =
            "exec --no-startup-id ${lib.getExe pkgs.pamixer} --toggle-mute --default-source";
          "XF86MonBrightnessUp" =
            "exec --no-startup-id ${lib.getExe pkgs.brightnessctl} --class=backlight set +5%";
